export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{ borderColor: 'rgba(125,223,170,0.07)' }}
    >
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <p className="text-muted text-sm text-center">
            ...
            <span
              aria-label="Google"
              style={{ background: 'linear-gradient(90deg, #4285F4, #34A853, #FBBC05, #EA4335)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}
            >
              Google
            </span>
            {' '}· Open Source
            ...
            <ul role="list" className="flex items-center gap-5">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted hover:text-[#E1306C] transition-colors"
        ...
        <div
          className="mt-12 pt-8 border-t flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted/60"
          style={{ borderColor: 'rgba(125,223,170,0.05)' }}
        >
          <nav aria-label="Legal and support links">
            <ul role="list" className="flex items-center gap-4">
              <li><a href="/privacy" className="hover:text-sand transition-colors">Privacy Policy</a></li>
              <li><a href="/terms" className="hover:text-sand transition-colors">Terms of Service</a></li>
              <li><a href="/faq" className="hover:text-sand transition-colors">FAQ</a></li>
              <li><a href="/contact" className="hover:text-sand transition-colors">Contact Us</a></li>
            </ul>
          </nav>
          <div>
            <span>© {currentYear} Earthly · </span>
