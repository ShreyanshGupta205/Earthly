...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with the creator of Earthly. Connect on LinkedIn, GitHub, or Instagram.',
}
  ...
  return (
    <main className="min-h-screen bg-bg flex flex-col">
      ...
      <div className="flex-1 max-w-3xl mx-auto px-6 py-32 w-full text-center">
        <div
          className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-lime/10 border border-lime/20 text-lime mb-6"
          aria-hidden="true"
        >
          <Mail size={32} />
        </div>
        ...
        <nav aria-label="Social contact links">
          <ul
            role="list"
          ...
          >
            <li>
              <a
                href="https://www.linkedin.com/in/shreyanshgupta205/"
                target="_blank"
              ...
              >
                <div
                  className="w-12 h-12 rounded-full bg-[#0A66C2]/10 text-[#0A66C2] flex items-center justify-center group-hover:bg-[#0A66C2] group-hover:text-white transition-colors"
                  aria-hidden="true"
                >
            ...
            <li>
              ...
              >
                <div
                  className="w-12 h-12 rounded-full bg-lime/10 text-lime flex items-center justify-center group-hover:bg-lime group-hover:text-black transition-colors"
                  aria-hidden="true"
                >
            ...
            <li>
              <a
                href="https://www.instagram.com/shreyanshg2005/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <div
                  className="w-12 h-12 rounded-full bg-[#E1306C]/10 text-[#E1306C] flex items-center justify-center group-hover:bg-[#E1306C] group-hover:text-white transition-colors"
                  aria-hidden="true"
                >
